      ...
      <div class="footer-grid">
        ...
        <div>
          ...
          <div class="social-icons">
            <a href="https://web.facebook.com/institutovonhumboldt/?locale=es_LA&_rdc=1&_rdr#" class="social-icon facebook" target="_blank" title="Facebook"></a>
        ...
        <div>
          ...
          <div class="map-container">
            <iframe 
              ...
              loading="lazy"
              title="Ubicación del Instituto Von Humboldt">
            </iframe>
          </div>

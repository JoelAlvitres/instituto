    ...
    <div class="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-8">
        ...
        <div class="flex-shrink-0 animate-fade-in-right">
          <a href="{{ route('public.admision.postular') }}"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid lg:grid-cols-12 gap-8">
        ...
        <div class="lg:col-span-7 space-y-6">
          {{-- Card de Requisitos --}}
          <div
            class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-[#6b3f8c]/10 group">
            <div class="flex items-center gap-4 mb-8">
              <div
                class="w-14 h-14 rounded-2xl bg-gradient-to-br from-[#faf5ff] to-[#6b3f8c]/10 flex items-center justify-center text-3xl shadow-md group-hover:scale-110 transition-transform duration-300">
                📋
              </div>
              <div>
            ...
            <ul class="space-y-4">
              @forelse($requisitos as $index => $r)
                <li
                  class="flex gap-4 p-4 bg-gradient-to-r from-[#faf5ff] to-white rounded-xl hover:from-[#c9a227]/10 hover:to-white transition-all duration-300 group/item border border-gray-100 hover:border-[#c9a227]/30 animate-fade-in-right"
                  style="animation-delay: {{ $index * 0.1 }}s">
                  <span
                    class="mt-0.5 w-7 h-7 rounded-lg bg-[#c9a227] text-white flex items-center justify-center font-bold shadow-md group-hover/item:scale-110 transition-transform">
                    ✓
                  </span>
          ...
          <div
            ...
            <div class="space-y-4">
              @forelse($cronograma as $index => $c)
                <div
                  class="flex items-center gap-4 p-4 bg-gradient-to-r from-[#faf5ff] to-white rounded-xl hover:from-[#c9a227]/10 hover:to-white transition-all duration-300 border border-gray-100 hover:border-[#c9a227]/30 animate-fade-in-right"
                  style="animation-delay: {{ $index * 0.1 }}s">
                  <div
                    class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#c9a227]/20 to-[#e67e22]/20 flex items-center justify-center text-xl font-bold text-[#c9a227]">
                    {{ $index + 1 }}
                  </div>
                  <div class="flex-1">
            ...
            <table class="w-full text-sm">
              ...
              <tbody class="divide-y divide-gray-100">
                @forelse($costos as $index => $p)
                  <tr class="hover:bg-[#faf5ff] transition-colors duration-300 animate-fade-in-up"
                    style="animation-delay: {{ $index * 0.1 }}s">
      ...
      <div class="mt-12 text-center">
        <a href="{{ route('public.admision.postular') }}"
          ...
          <span
            class="absolute inset-0 bg-gradient-to-r from-[#e67e22] to-[#c9a227] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
          <span class="relative text-2xl">📝</span>
          <span class="relative text-xl">Iniciar mi Postulación</span>
        </a>
        <p class="mt-4 text-sm text-gray-500">¿Tienes dudas? <a href="{{ route('public.contacto') }}"
            class="text-[#c9a227] hover:underline font-semibold">Contáctanos</a></p>
      </div>

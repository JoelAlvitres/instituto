...
<section class="bg-gradient-to-b from-slate-50 to-white">
  <div class="max-w-6xl mx-auto px-4 py-8">
    ...
    <div class="text-xs text-slate-500">
      ...
      <a class="hover:underline" href="{{ route('public.carreras.index') }}">Programas de Estudio</a>
      <span class="mx-1">/</span>
      <span class="text-slate-700 font-medium">{{ $carrera->nombre }}</span>
    </div>

    {{-- Encabezado tipo referencia --}}
    ...
    <div class="mt-6 grid lg:grid-cols-12 gap-6">
      ...
      <div class="lg:col-span-8 space-y-6">
        ...
        {{-- Card principal (título carrera + imagen + resumen) --}}
          ...
          <div class="grid md:grid-cols-2">
            ...
            <div class="p-6">
              <p class="text-sm text-slate-600">
                {!! $carrera->descripcion
                    ? $carrera->descripcion
                    : 'Formamos profesionales con conocimientos sólidos y enfoque práctico para el mundo laboral.' !!}
              </p>

              {{-- OJO: aquí NO ponemos la franja de botones grande (se elimina como pediste) --}}
              <div class="mt-4 text-xs text-slate-500">
                (Acciones y descargas están en el panel derecho.)
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="bg-white border rounded-2xl p-6">
          ...
          {{-- Bloque tipo referencia (título + caja) --}}
          ...
          <div class="mt-4">
            @if($carrera->malla_pdf)
              ...
              <div class="mt-3 flex flex-wrap gap-2">
                <a class="rounded-xl border px-4 py-2 text-sm hover:bg-slate-50"
      ...
      {{-- SIDEBAR (como en la imagen) --}}
      <aside class="lg:col-span-4 space-y-6">

        {{-- Programas de estudio (lista con scroll) --}}
        <div class="bg-white border rounded-2xl p-5">
          ...
          {{-- Botones amarillos (como referencia) --}}
          ...
          @else
            <div class="mt-3 w-full inline-flex justify-center rounded-xl bg-slate-100 px-4 py-2 text-slate-500 text-sm font-semibold border">
              (Sube el plan PDF en admin)
            </div>
          @endif
        </div>

        {{-- Otros programas (opcional como en referencia) --}}
        <div class="bg-white border rounded-2xl p-5">

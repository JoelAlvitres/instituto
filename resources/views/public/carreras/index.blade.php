  ...
  <section class="relative min-h-[70vh] md:min-h-[80vh] flex items-center overflow-hidden">
    ...
    @if(!empty($carrera->imagen))
      <div class="absolute inset-0 overflow-hidden">
        ...
        <img src="{{ asset('storage/' . $carrera->imagen) }}" alt="Fondo {{ $carrera->nombre }}"
    ...
    <div class="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
      ...
      <div class="flex items-center text-sm text-white/80 mb-8 space-x-2 animate-fade-in-down">
        ...
        <a href="{{ route('public.carreras.index') }}"
          class="hover:text-[#c9a227] transition-colors duration-300">Programas</a>
        <span class="text-white/40">/</span>
      ...
      <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-12">
        ...
        <div class="flex-1 max-w-3xl">
          ...
          <div
            class="inline-flex items-center px-3 py-1 bg-white/10 backdrop-blur-md rounded-full border border-[#c9a227]/30 mb-6">
          ...
          <div class="flex flex-wrap gap-4">
            <a href="{{ route('public.admision') }}"
              ...
              <span
                class="absolute inset-0 bg-gradient-to-r from-[#b38b1f] to-[#c9a227] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            ...
            <a href="{{ route('public.contacto') }}"
              ...
              <span
                class="absolute inset-0 bg-[#6b3f8c]/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
              <span class="relative text-lg">📞</span>
              <span class="relative">Solicitar Información</span>
            </a>
            @if($carrera->plan_estudios_pdf)
              <a href="{{ asset('storage/' . $carrera->plan_estudios_pdf) }}" target="_blank"
                ...
                <span
                  class="absolute inset-0 bg-[#6b3f8c]/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                <span class="relative text-lg">📥</span>
        ...
        @if(!empty($carrera->imagen))
          <div class="flex-shrink-0 w-full max-w-[400px] mx-auto animate-float">
            <div class="relative group perspective-1000" style="height: 300px;">
              ...
              <div
                class="absolute -inset-2 bg-gradient-to-r from-[#c9a227] via-[#6b3f8c] to-[#c9a227] rounded-3xl blur-2xl opacity-40 group-hover:opacity-60 transition-opacity duration-500 animate-gradient">
              </div>

              {{-- Segundo marco para más profundidad --}}
              <div
                class="absolute -inset-1 bg-gradient-to-r from-[#4a2e6e] to-[#6b3f8c] rounded-3xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity duration-500">
              </div>

              {{-- Imagen principal con efectos 3D --}}
              <div
                class="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border-2 border-[#c9a227]/30 transform-gpu group-hover:rotate-y-3 group-hover:scale-105 transition-all duration-700 ease-out">
                <img src="{{ asset('storage/' . $carrera->imagen) }}" alt="{{ $carrera->nombre }}"
                  class="w-full h-full object-cover transform group-hover:scale-110 transition-transform duration-700">

                {{-- Overlay con gradiente institucional --}}
                <div
                  class="absolute inset-0 bg-gradient-to-t from-[#4a2e6e]/70 via-[#6b3f8c]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                </div>

                {{-- Efecto de brillo esquina --}}
                <div
                  class="absolute top-0 left-0 w-32 h-32 bg-gradient-to-br from-[#c9a227]/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 transform -rotate-45 -translate-x-16 -translate-y-16 group-hover:translate-x-0 group-hover:translate-y-0">
                </div>
              </div>

              {{-- Sombra proyectada --}}
              <div
                class="absolute -bottom-6 left-10 right-10 h-8 bg-[#4a2e6e]/30 rounded-full blur-xl opacity-0 group-hover:opacity-70 transition-opacity duration-500">
              </div>
            </div>
          </div>
        @else
          <div class="flex-shrink-0 w-full max-w-[400px] mx-auto animate-float">
            <div class="relative group perspective-1000" style="height: 300px;">
              <div
                class="absolute -inset-2 bg-gradient-to-r from-[#c9a227] via-[#6b3f8c] to-[#c9a227] rounded-3xl blur-2xl opacity-40">
              </div>
              <div class="absolute -inset-1 bg-gradient-to-r from-[#4a2e6e] to-[#6b3f8c] rounded-3xl blur-xl opacity-30">
              </div>
              <div
                class="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border-2 border-[#c9a227]/20 bg-gradient-to-br from-[#6b3f8c] to-[#4a2e6e] p-12 text-center transform-gpu group-hover:rotate-y-3 group-hover:scale-105 transition-all duration-700 flex flex-col items-center justify-center">
  ...
  <section class="bg-[#faf5ff] py-20">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid lg:grid-cols-12 gap-12">
        ...
        <div class="lg:col-span-8 space-y-12">
          ...
          {{-- PERFIL PROFESIONAL --}}
          <div
            class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-[#6b3f8c]/10">
            <div class="flex items-center gap-4 mb-8">
              <div
                class="w-16 h-16 rounded-2xl bg-gradient-to-br from-[#faf5ff] to-[#6b3f8c]/10 flex items-center justify-center text-4xl shadow-lg">
                👤
              </div>
              <div>
    ...
    ?? '<p class="text-gray-600 italic">Complete este contenido desde el panel de administración.</p>' !!}
            ...
            @if(count($campoItems))
              <div class="grid sm:grid-cols-2 gap-4">
                @foreach($campoItems as $it)
                  <div
                    class="flex items-center gap-4 p-5 bg-gradient-to-r from-[#faf5ff] to-white rounded-2xl hover:from-[#c9a227]/10 hover:to-white transition-all duration-300 group border border-gray-200 hover:border-[#c9a227]/30">
            ...
            <div class="flex items-center justify-between gap-4 flex-wrap mb-8">
              ...
              @if($carrera->plan_estudios_pdf)
                <a class="group relative inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#6b3f8c] to-[#4a2e6e] px-6 py-3 text-white text-sm font-semibold overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300"
                  ...
                  <span
                    class="absolute inset-0 bg-gradient-to-r from-[#c9a227] to-[#b38b1f] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  <span class="relative text-lg">📥</span>
                  <span class="relative">Descargar Plan</span>
                </a>
              @endif
              ...
              @elseif($carrera->malla_imagen)
                <div class="rounded-2xl border-2 border-gray-200 overflow-hidden bg-white">
                  <img src="{{ asset('storage/' . $carrera->malla_imagen) }}"
                    class="w-full h-auto hover:scale-105 transition-transform duration-700" alt="Malla curricular">
                </div>
              @else
                <div
                  class="text-center py-16 bg-gradient-to-br from-[#faf5ff] to-white rounded-2xl border-2 border-dashed border-gray-300">
            ...
            <div
              ...
              <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm">
                <table class="w-full text-left border-collapse">
                  <thead>
                    <tr class="bg-gradient-to-r from-[#6b3f8c] to-[#4a2e6e] text-white">
                      <th class="p-4 font-bold border-r border-white/10 uppercase tracking-wider text-xs">SEDE / FILIAL</th>
                      <th class="p-4 font-bold border-r border-white/10 uppercase tracking-wider text-xs">TURNO DE ATENCIÓN
                      </th>
                      <th class="p-4 font-bold uppercase tracking-wider text-xs text-center">HORARIO</th>
                    </tr>
                  </thead>
                  <tbody>
                    @foreach($carrera->itinerario as $item)
                      <tr
                        class="hover:bg-[#faf5ff] transition-colors duration-300 border-b border-gray-100 last:border-0 text-gray-800">
                        <td class="p-4 font-semibold border-r border-gray-100">{{ $item['sede'] ?? '-' }}</td>
                        <td class="p-4 border-r border-gray-100">
                          <span
                            class="inline-flex items-center px-3 py-1 bg-[#6b3f8c]/10 text-[#6b3f8c] rounded-full text-xs font-bold uppercase tracking-wider">
                            {{ $item['turno'] ?? '-' }}
                          </span>
                        </td>
                        <td class="p-4 font-medium text-[#4a2e6e] text-center">{{ $item['horario'] ?? '-' }}</td>
                      </tr>
                    @endforeach
                  </tbody>
                </table>
        ...
        <aside class="lg:col-span-4 space-y-8">
          ...
          <div
            class="bg-white rounded-3xl p-8 shadow-xl hover:shadow-2xl transition-all duration-500 border border-[#6b3f8c]/10 sticky top-24">
            <div class="flex items-center gap-4 mb-8">
              <div
                class="w-12 h-12 rounded-xl bg-gradient-to-br from-[#faf5ff] to-[#6b3f8c]/10 flex items-center justify-center text-2xl shadow-md">
            ...
            <div class="space-y-3 max-h-[350px] overflow-y-auto pr-2 custom-scrollbar" id="programList">
              @foreach($programasSidebar as $p)
                ...
                : 'hover:bg-[#faf5ff] hover:border-l-4 hover:border-[#c9a227]/50' }}">
                          <span
                            class="w-2 h-2 rounded-full {{ $p->id === $carrera->id ? 'bg-[#c9a227]' : 'bg-gray-300 group-hover:bg-[#c9a227]' }} transition-all"></span>
                          <span
                            class="flex-1 {{ $p->id === $carrera->id ? 'text-[#4a2e6e] font-semibold' : 'text-gray-800 group-hover:text-[#4a2e6e]' }}">
                            {{ $p->nombre }}
                          </span>
                          @if($p->id === $carrera->id)
            ...
            <div class="mt-8 pt-6 border-t border-gray-200">
              <a href="{{ route('public.carreras.index') }}"
                ...
                <span
                  class="absolute inset-0 bg-gradient-to-r from-[#c9a227] to-[#e67e22] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
            ...
            <div class="space-y-3 mt-8">
              ...
              <a href="{{ route('public.contacto') }}"
                ...
                <span
                  class="absolute inset-0 bg-gradient-to-r from-[#c9a227] to-[#b38b1f] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                <span
                  class="relative flex items-center justify-center gap-2 group-hover:text-white transition-colors duration-300">
                  <span class="text-lg">📞</span>
              ...
              @if($carrera->plan_estudios_pdf)
                <a href="{{ asset('storage/' . $carrera->plan_estudios_pdf) }}" target="_blank"
                  ...
                  <span
                    class="absolute inset-0 bg-gradient-to-r from-[#4a2e6e] to-[#6b3f8c] opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
                  <span class="relative flex items-center justify-center gap-2">
                    <span class="text-lg">📥</span>
                    Descargar Plan
                  </span>
...
@section('styles')
  <style>
    ...
    :root {
      --humboldt-purple-dark: #4a2e6e;
      /* Morado oscuro más lila */
      --humboldt-purple-medium: #6b3f8c;
      /* Morado medio más suave */
      --humboldt-purple: #8f55b5;
      /* Morado principal más lila */
      --humboldt-purple-light: #b27fd6;
      /* Lila claro */
      --humboldt-gold: #c9a227;
      /* Dorado se mantiene */
      --humboldt-gold-dark: #b38b1f;
      --humboldt-gold-light: #e2c45a;
      --humboldt-bg-light: #faf5ff;
      /* Fondo ligeramente más lila */
    }
    ...
    .lg\:col-span-8>div:nth-child(1) {
      animation-delay: 0.2s;
    }

    .lg\:col-span-8>div:nth-child(2) {
      animation-delay: 0.3s;
    }

    .lg\:col-span-8>div:nth-child(3) {
